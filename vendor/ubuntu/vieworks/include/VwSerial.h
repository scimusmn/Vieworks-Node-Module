...
private:
    int			   clSerialRead				(CHAR    *buffer,    __uint64* bufferSize        );
    int			   clSerialWrite			(CHAR    *buffer,    __uint64* bufferSize        );
    int			   Align32					(uint32_t param,     uint32_t alignment, bool up );
